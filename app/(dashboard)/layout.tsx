...
export default async function DashboardLayout({
	...
	return (
		<div className='overflow-x-hidden min-h-screen flex items-center justify-center max-w-7xl m-auto px-0 sm:px-4 bg-background'>
			...
			<div className='pt-18 pb-18'>{children}</div>
		</div>
	)
}
